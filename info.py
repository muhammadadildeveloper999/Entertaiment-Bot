...
PORT = int(environ.get('PORT', 8080))  # Default to 8000 for worker dyno
...
WORKERS = int(environ.get('WORKERS', '4'))  # Adjust workers based on your requirements
